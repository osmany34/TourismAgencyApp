...
public class RoomDao {
    ...
    public Room match(ResultSet rs) throws SQLException {
        ...
        obj.setAir(rs.getBoolean("air"));
        obj.setIron(rs.getBoolean("iron"));
        obj.setCafe(rs.getBoolean("cafe"));
        return obj;
    }
    ...
    public boolean save(Room room) {
        ...
        try {
            ...
            pr.setBoolean(12, room.isAir());
            pr.setBoolean(13, room.isCafe());
            pr.setBoolean(14, room.isIron());
